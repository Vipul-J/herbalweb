...
function Allcustomer() {
  const initialStaff = [
    ...
    { name: 'Aftab A', id: '004', phone: '(555) 123-4569', eligible: 'No' },
    { name: 'Vipul J', id: '005', phone: '(555) 123-4562', eligible: 'Yes' },
    { name: 'Subaita', id: '006', phone: '(555) 123-4565', eligible: 'Yes' },
    ...
    <div className="container">
      ...
      <div className="mb-3">
        <div className="row">
          ...
          <div className="col-auto">
            <a className="btn btn-warning" href="/addcustomers">
              Add Customer
            </a>
          </div>
        </div>
